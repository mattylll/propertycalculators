...
export default function AuctionBridgeCalculatorPage() {
  ...
  return (
    <CalculatorPageLayout
      title="Auction Bridge Calculator"
      description="Calculate bridging for auction purchases with 28-day completion. Model fast-track finance for auction properties."
      category="Bridging"
      categorySlug="bridging"
      categoryColor="#F59E0B"
      badges={[
        { label: `${completionDays} Days`, variant: getCompletionStatus().tone }
      ]}
    >
