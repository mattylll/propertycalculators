...
const developmentCalculators: CalculatorConfig[] = [
  ...
  },
  {
    ...
    slug: 'development-appraisal-calculator',
    name: 'Development Appraisal Calculator',
    shortName: 'Dev Appraisal',
    description: 'Full development appraisal combining GDV, costs, and finance into a single viability analysis',
    category: 'development',
    icon: 'Building2',
    color: '#00C9A7',
    href: '/development/development-appraisal-calculator',
    status: 'live',
    keywords: ['development appraisal', 'feasibility calculator', 'viability assessment'],
    workflows: ['full-development'],
  },
  {
    id: 'gdv',
